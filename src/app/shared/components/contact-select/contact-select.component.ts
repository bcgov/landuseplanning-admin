...
import { GroupsTableRowsComponent } from 'app/project/project-groups/project-groups-table-rows/project-groups-table-rows.component';
import { PinsTableRowsComponent } from 'app/project/pins-list/pins-table-rows/pins-table-rows.component';
