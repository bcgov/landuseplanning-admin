export class Constants {
  ...
  public static readonly subtypes = {
    ...
    PERMIT: ['INVESTIGATIVE PERMIT', 'PRE-TANTALIS PERMIT', 'ROADS & BRIDGES', 'TEMPORARY CODE', 'TEMPORARY PERMIT'],
    ...
    'RIGHT-OF-WAY': ['INTERIM LICENCE', 'STATUTORY RIGHT OF WAY OR EASEMENT', 'PRE-TANTALIS RIGHT-OF-WAY'],
    'TRANSFER OF ADMINISTRATION/CONTROL': [
  ...
  public static readonly subpurposes = {
    AGRICULTURE: ['EXTENSIVE', 'INTENSIVE', 'GRAZING'],
    ...
    AQUACULTURE: ['FIN FISH', 'SHELL FISH', 'PLANTS', 'CRUSTACEANS'],
    COMMERCIAL: [
      'GENERAL',
      'COMMERCIAL A',
      'COMMERCIAL B',
    ...
    COMMUNICATION: ['COMMUNICATION SITES', 'COMBINED USES'],
    ...
    'OCEAN ENERGY': ['INVESTIGATIVE AND MONITORING PHASE', 'GENERAL AREA'],
    // 'PRE-TANTALIS': [
    //   'PRE-TANTALIS', // ACRFD does not have pre-Tantalis apps
    // ],
    QUARRYING: [
