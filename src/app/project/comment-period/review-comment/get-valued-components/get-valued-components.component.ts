...
export class GetValuedComponentsComponent implements OnInit, OnDestroy {
  ...
  getPaginatedVCs(pageNumber, newSortBy, newSortDirection) {
    ...
    this.valuedComponentService.getAllByProjectId(this.currentProjectId, this.tableParams.currentPage, this.tableParams.pageSize, this.tableParams.sortString)
      .takeUntil(this.ngUnsubscribe)
      .subscribe((res: any) => {
        this.tableParams.totalListItems = res.totalCount;
        this.valuedComponents = res.data;
