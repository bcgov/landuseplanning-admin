...
import { ShapefileTableRowsComponent } from './project-shapefile-table-rows/project-shapefile-table-rows.component';
...
@Component({
  selector: 'app-project-shapefiles',
  templateUrl: './project-shapefiles.component.html',
  styleUrls: ['./project-shapefiles.component.scss']
})
export class ProjectShapefilesComponent implements OnInit, OnDestroy {
  ...
  public onNumItems(numItems) {
    ...
    this.router.navigate(['p', this.currentProject._id, 'project-shapefiles', params]);
  }
